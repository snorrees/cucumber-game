 ...
 */
public class TextureAssetManager extends AssetManager<TextureRef, TextureComponent> {
    ...
    public TextureAssetManager() {
        super(TextureRef.class, TextureComponent.class);
    }

    @Override
    public void setup(Entity entity, TextureRef textureRef, TextureComponent textureComponent) {
        if (isEnabled()) {
